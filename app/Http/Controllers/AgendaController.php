...
class AgendaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            // redirect
            Session::flash('message', 'Successfully created agenda item!');
    ...
    public function update(Request $request, $id)
    {
        ...
        // process the login
        if ($validator->fails()) {
            return Redirect::to('agenda/' . $id . '/edit')
                ->withErrors($validator)
                ->withInput(Input::except('password'));
        } else {
            // store
...
//            }
    ...
    public function destroy($id)
    {
        ...
        // redirect
        Session::flash('message', 'Successfully deleted the agenda item!');
        return Redirect::to('agenda');
    }
}
