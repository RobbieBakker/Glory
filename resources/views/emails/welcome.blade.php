<head>
    ...
    * {
    ...
    @media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min--moz-device-pixel-ratio: 2), only screen and (-o-min-device-pixel-ratio: 2/1), only screen and (min-device-pixel-ratio: 2), only screen and (min-resolution: 192dpi), only screen and (min-resolution: 2dppx) {
      .fblike {
        background-image: url(http://i10.createsend1.com/static/eb/master/13-the-blueprint-3/images/fblike@2x.png) !important;
      }
      .tweet {
        background-image: url(http://i7.createsend1.com/static/eb/master/13-the-blueprint-3/images/tweet@2x.png) !important;
      }
      .linkedinshare {
    ...
    <meta property="og:title" content="Welkom bij CJK Glory">
</head>

<body class="full-padding" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;" cz-shortcut-listen="true">
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #f0f0f0;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
        ...
        <div class="preheader" style="Margin: 0 auto;max-width: 560px;min-width: 280px; width: 280px;width: calc(28000% - 167440px);">
          ...
          <!--[if (mso)|(IE)]><table align="center" class="preheader" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="width: 280px" valign="top"><![endif]-->
            <div class="snippet" style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 140px; width: 140px;width: calc(14000% - 78120px);padding: 10px 0 5px 0;color: #bdbdbd;font-family: Ubuntu,sans-serif;">
              <div style="mso-hide:all;position:fixed;height:0;max-height:0;overflow:hidden;font-size:0;">Welkom bij CJK Glory!</div>
            </div>
          <!--[if (mso)|(IE)]></td><td style="width: 280px" valign="top"><![endif]-->
            <!--<div class="webversion" style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 139px; width: 139px;width: calc(14100% - 78680px);padding: 10px 0 5px 0;text-align: right;color: #bdbdbd;font-family: Ubuntu,sans-serif;">
              <p style="Margin-top: 0;Margin-bottom: 0;">Geen afbeeldingen? <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #bdbdbd;" href="http://memyselfandi.createsend1.com/t/j-e-bakltk-l-t/">Webversie</a></p>
            </div>-->
      ...
      <div class="layout one-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
        ...
        <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
          <img style="border: 0;display: block;height: auto;width: 100%;max-width: 600px;" alt="" width="600" src="http://i1.createsend1.com/ei/j/75/238/CAB/081742/csfinal/144b28883cb7494b9b2de7294a8a861e.png">
        </div>
...
<p style="Margin-top: 20px;Margin-bottom: 20px;">Nogmaals welkom, en tot snel! :)</p>
      ...
      <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
        <!--[if !mso]--><a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #80bf2e;font-family: Ubuntu, sans-serif;" href="http://www.jongerenkoorglory.nl/login">Log in op de website</a><!--[endif]-->
      <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://www.jongerenkoorglory.nl/login" style="width:184px" arcsize="9%" fillcolor="#80BF2E" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Ubuntu,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">Log in op de<br>
website</center></v:textbox></v:roundrect><![endif]--></div>
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
        <p class="size-10" style="Margin-top: 0;Margin-bottom: 0;font-size: 10px;line-height: 18px;" lang="x-size-10"><em>Al je informatie behandelen we alsof het ons geheimpje is: heel vertrouwelijk dus! Je zal ons dan ook nooit jouw gegevens aan derden zien doorfluisteren/-vertellen/-schreeuwen/-zingen!&nbsp;</em></p>
      </div>
    </div>
      ...
      <div class="layout one-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
        ...
        <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
          <img style="border: 0;display: block;height: auto;width: 100%;max-width: 100px;" alt="" width="100" src="http://i2.createsend1.com/ei/j/75/238/CAB/081742/csfinal/7f61e7f13e604f1e87b41956deb991a4.png">
        </div>
          ...
          <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-email-footer"><td style="width: 400px;" valign="top" class="w360"><![endif]-->
            <div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #bdbdbd;font-family: Ubuntu,sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
              <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                ...
                <td class="emb-web-links" style="padding: 0;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #bdbdbd;" href="https://www.facebook.nl/jongerenkoorglory"><img style="border: 0;" src="http://i2.createsend1.com/static/eb/master/13-the-blueprint-3/images/facebook.png" width="26" height="26" alt="Facebook"></a></td><td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #bdbdbd;" href="http://www.jongerenkoorglory.nl"><img style="border: 0;" src="http://i7.createsend1.com/static/eb/master/13-the-blueprint-3/images/website.png" width="26" height="26" alt="Website"></a></td>
                </tr></tbody></table>
                <div style="font-size: 12px;line-height: 19px;Margin-top: 20px;">
                  <div>Christelijk Jongerenkoor Glory<br>
Peulenlaan 245,&nbsp;3371XL Hardinxveld-Giessendam</div>
                </div>
                <div style="font-size: 12px;line-height: 19px;Margin-top: 18px;">
                  <div>Je ontvangt deze e-mail omdat je met dit e-mailadres staat ingeschreven bij Christelijk Jongerenkoor Glory. Is deze mail niet voor jou bedoeld? Oeps! Dan is er vast ergens iets misgegaan! Wil je dit alsjeblieft aan ons laten weten door een mailtje te sturen naar info@jongerenkoorglory.nl?</div>
                </div>
                <!--[if mso]>&nbsp;<![endif]-->
              </div>
            </div>
            ...
            <div class="column" style="text-align: left;font-size: 12px;line-height: 19px;color: #bdbdbd;font-family: Ubuntu,sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
              <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                <div style="font-size: 12px;line-height: 19px;">
                  <!--<a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #bdbdbd;" href="http://memyselfandi.createsend1.com/t/j-u-bakltk-l-i/">Uitschrijven</a>-->
                </div>
              </div>
            </div>
          <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
  ...
  <!--<img style="overflow: hidden;position: fixed;visibility: hidden !important;display: block !important;height: 1px !important;width: 1px !important;border: 0 !important;margin: 0 !important;padding: 0 !important;" src="http://memyselfandi.createsend1.com/t/j-o-bakltk-l/o.gif" width="1" height="1" border="0" alt="">-->
