    ...
    @parent
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p>Een zangseizoen loopt van eind augustus tot begin juli. Het kan gebeuren dat er in de schoolvakanties ook repetities zijn gepland. Van de leden wordt gevraagd zich voortijdig af te melden. Leden van de vereniging betalen contributie. De contributie bedraagt &euro;100,- per jaar. Dit bedrag kan in één keer voldaan worden, in 2 termijnen van à &euro;51,- of 4 termijnen van à &euro;26,-.</p>
            </div>
        </div>
        <!-- /.row -->
        ...
        <!-- <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p><b>Kosten: </b> &euro;100,- op jaarbasis</p>
                <p><b>Tijden: </b></p>
                <p></p>
                <p></p>
            </div>
